# Boas vindas, devs do projeto!
O objetivo dessa página é organizar os ajustes de todos os jogos para ganharmos mais agilidade na entrega deles e discutir problemas de uma forma centralizada. As regras estão em cada lista, mas vou deixar aqui também pra ajudar:
...
#### Em seguida, os prazos
Depois das tags coloridas, você coloca os prazos entre os parênteses (PRAZO) dentro da medida informada em cada arquivo:

0,5 dia//1 dia//1,5 dia//2 dias//3+ dias
...
#### Por fim, os comentários
Se você sentir necessidade de explicar o ajuste de alguma forma, se tiver algum comentário para fazer que vai começar uma discussão sobre o ajuste, escreva nesse formato e vou te mandar mensagem no privado para entendermos que caminho seguir:
...
- Compilação em .apk
	- Envio pelo OneDrive na pasta do projeto;
- Avaliação Gaz Games;
- Loop de retorno de ajustes até que fique no ponto pra mandar pro cliente
	- Note que, mesmo que sejam ajustes do cliente, haverá ajustes da Gaz se simplesmente não estiver 100% correto com o ajuste, as vezes coisas vão quebrar ou ser feitas de forma não compatível. O cliente só fará 1 rodada de ajuste, mas não quer dizer que será apenas 1 envio para mim;
