...
- [ ] Quando é feito o corte errado, não em opção de corrigir. Colocar uma opção/botão para isso.
- [ ] Algumas vezes, ao selecionar o garfo (e ele fica “piscando), há uma demora ao selecionar as fatias.