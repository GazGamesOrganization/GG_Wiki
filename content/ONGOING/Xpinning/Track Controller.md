...
É onde faz o lerp usando (MoveTowards) para as variáveis atuais chegarem nas variáveis alvo utilizando os CHANGE_RATES como velocidade


## ATTRIBUTES

### Angle
- `SetAngle(Angle)` - Ele altera o valor do ângulo alvo em um Clamp que limita entre o valor mínimo e máximo
- `SetAngleImmediately(float angle)` - Ele altera o valor do ângulo alvo e o atual em um Clamp que limita entre o valor mínimo e máximo. Evitando aquele Lerp entre as 2 variáveis 